...
Because of work, started working on a way to import cols into sage crm from a csv file, had to do some python though - so added some ironpython usage into the project as well  

## Resources

- Brain, and some google
...
- Worked too hard for current result, keep at it though mike :)