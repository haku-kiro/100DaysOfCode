...
- The cheatsheets available on datacamp are really good in the case that you need quick help/ or a refresher
- Read more into the numpy transpose method

- To get the last element in each array : ends = np_aw_t[-1,:]